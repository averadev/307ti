 ...
 <fieldset id="CCASR" class="fieldset">
    ...
    <div class="row">
        ...
        <div class="small-9 columns">
        	<input class="round general" type="text" id="numeroTarjetaASR" name="numeroTarjetaAS" value=<?php echo $CCNumber;?> class="general" required>
        </div>
    </div>
                <!-- Numero de tarjeta-->
                <div class="row" >
                    ...
                    <div class="small-9 columns">
                          <div class="caja">
                            <select id="cardTypesASR" class="input-group-field round">
						<?php
						$html = "";
                ...
                <div class="row">
                    ...
                    <div class="small-9 columns">
                        <input class="round general" value=<?php echo $ExpDate; ?> type="text" id="dateExpiracionASR" name="dateExpiracionAS" class="general" required>
                    </div>
                </div>
                 <!-- Codigo Postal-->
                <div class="row">
                    ...
                    <div class="small-9 columns">
                        <input class="round general" value=<?php echo $ZIP; ?> type="text" id="codigoPostalASR" name="codigoPostalASR" class="general" required>
                    </div>
                </div>
                <!-- Codigo tarjeta-->
                <div class="row">
                   ...
                   <div class="small-9 columns">
                        <input class="round general" value=<?php echo $Code; ?> type="text" id="codigoTarjetaASR" name="codigoTarjetaAS" class="general" required>
                    </div>
                </div>
    </fieldset>