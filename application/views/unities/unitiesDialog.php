<div class="row section" id="section-unities">
	<div class="large-12 columns">
		<div class="box" relation-attr="box-unities-relation">
	...
	<div class="large-12 columns" id="box-unities-relation">
		<div class="box">
			<div class="box-header pr-color">
				<div class="pull-right box-tools">
               </div>
			...
			<div class="box-body" id="table-units" style="display: block;">
				<div class="table" >
